...
there are cases where it make sense to "do it yourself."  For Doxygen,
these include:
...
use the [on-line documentation][on-line version] and skip the rest of
this chapter.**
...
This will open the landing page of a local copy of the complete BioCro
Doxygen documentation in your default browser, generating it first if
needed.

(If the browser should fail to open the landing page, open the file
`doxygen/doxygen_docs_complete/html/index.html` manually in your
browser.)

Once you have your browser open to the documentation, you can update
the documentation after making changes to the source-code files by
simply typing
