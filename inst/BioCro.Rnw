...
pdf("./figure/BioCro-plotBioGro.pdf")
plot(res)
dev.off()
@
\begin{figure}[htbp!]
  \centering
  \includegraphics[scale=0.8]{./figure/BioCro-plotBioGro.pdf}
...
% pdf("./figure/Intro-op100resid.pdf")
% plot(op100, resid="raw")
% dev.off()
% @
% \begin{figure}[htbp!]
%   \centering
%   \includegraphics[scale=0.8]{./figure/Intro-op100resid}
...
% pdf("./figure/Intro-op100-OvsF.pdf")
% plot(op100, plot.kind="OvsF")
% dev.off()
% pdf("./figure/Intro-op100-OandF.pdf")
% plot(op100, plot.kind="OandF", type='o')
% dev.off()
% @
% \begin{figure}[htbp!]
%   \centering
%   \includegraphics[scale=0.8]{./figure/Intro-op100-OvsF}  
...
% \begin{figure}[htbp!]
%   \centering
%   \includegraphics[scale=0.8]{./figure/Intro-op100-OandF}  
