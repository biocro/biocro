soybean2 <- list(
    ...
    parameters = list(
        alpha1                      = 0,
        alphab1                     = 0,
        alphaLeaf                   = 46.0996485525336,
        alphaRhizome                = 0,
        alphaRoot                   = 49.8060417710803,
        alphaSeneLeaf               = 29.6932431532305,
        alphaSeneRhizome            = 10,
        alphaSeneRoot               = 10,
        alphaSeneStem               = 20.606537137685,
        alphaShell                  = 35.2695056962884,
        alphaStem                   = 47.4249281952858,
        ...
        beta_PSII                   = 0.5,
        betaLeaf                    = -33.0413869003197,
        betaRhizome                 = -Inf,
        betaRoot                    = -37.8935882501202,
        betaSeneLeaf                = -17.663795642942,
        betaSeneRhizome             = -10,
        betaSeneRoot                = -10,
        betaSeneStem                = -9.21561714494601,
        betaShell                   = -24.2429864891193,
        betaStem                    = -33.5633726981832,
        Catm                        = 372.59,
        chil                        = 0.81,
        curve_number                = 61,
        ...
        grc_leaf                    = 0,
        grc_rhizome                 = 0,
        grc_root                    = 0.0079268555636458,
        grc_shell                   = 0,
        grc_stem                    = 0.0248155763482675,
        ...
        min_root_depth              = 5,
        mrc_grain                   = 0,
        mrc_leaf                    = 0.000466141084223924,
        mrc_rhizome                 = 0,
        mrc_root                    = 2.93345503831618e-05,
        mrc_shell                   = 0,
        mrc_stem                    = 0.000466141084223924,
        O2                          = 210,
        ...
        phi_PSII_1                  = 0.022,
        phi_PSII_2                  = -0.00034,
        rateSeneLeaf                = 0.0100869445799617,
        rateSeneRhizome             = 0,
        rateSeneRoot                = 0,
        rateSeneStem                = 0.000677763386576955,
        ...
        StomataWS_gradient          = 0.334,
        StomataWS_intercept         = 0.429,
        StomataWS_min               = 0.01,
