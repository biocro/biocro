soybean2 <- list(
    direct_modules = list(
        ...
        stomata_water_stress = "BioCro:stomata_water_stress_bilinear",
    ...
    parameters = list(
        alpha1                      = 0,
        alphab1                     = 0,
        alphaLeaf                   = 33.7815318505556,
        alphaRhizome                = 0,
        alphaRoot                   = 37.7600649218713,
        alphaSeneLeaf               = 16.3083803640367,
        alphaSeneRhizome            = 10,
        alphaSeneRoot               = 10,
        alphaSeneStem               = 13.7330533936364,
        alphaShell                  = 24.4424458493407,
        alphaStem                   = 33.576466350084,
        ...
        beta_PSII                   = 0.5,
        betaLeaf                    = -23.4591850538465,
        betaRhizome                 = -Inf,
        betaRoot                    = -28.6241997503791,
        betaSeneLeaf                = -9.40062724095197,
        betaSeneRhizome             = -10,
        betaSeneRoot                = -10,
        betaSeneStem                = -7.29093866662779,
        betaShell                   = -16.5291458514314,
        betaStem                    = -22.6713767418601,
        Catm                        = 372.59,
        chil                        = 0.81,
        curve_number                = 61,
        ...
        grc_leaf                    = 0,
        grc_rhizome                 = 0,
        grc_root                    = 0.0125089553670907,
        grc_shell                   = 0,
        grc_stem                    = 0.00967062169906868,
        ...
        min_root_depth              = 5,
        mrc_grain                   = 0,
        mrc_leaf                    = 0.000647311725107347,
        mrc_rhizome                 = 0,
        mrc_root                    = 4.03854547220256e-05,
        mrc_shell                   = 0,
        mrc_stem                    = 0.000647311725107347,
        O2                          = 210,
        ...
        phi_PSII_1                  = 0.022,
        phi_PSII_2                  = -0.00034,
        rateSeneLeaf                = 0.00944205764427168,
        rateSeneRhizome             = 0,
        rateSeneRoot                = 0,
        rateSeneStem                = 0.000673116943179565,
        ...
        soil_depth_5                = 20,
        soil_depth_6                = 25,
        soil_type_indicator_1       = 6,
        soil_type_indicator_2       = 6,
        soil_type_indicator_3       = 7,
        soil_type_indicator_4       = 7,
        soil_type_indicator_5       = 7,
        soil_type_indicator_6       = 7,
        sowing_fractional_doy       = 0,
        Sp_thermal_time_decay       = 0,
        StomataWS_gradient          = 0.31,
        StomataWS_intercept         = 0.45,
        StomataWS_min               = 0.01,
