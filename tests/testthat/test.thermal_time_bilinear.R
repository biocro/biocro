...
test_cases <- list(
    #    tbase temp tmax topt | TTc
    tc(c(20,   10,  44,  32,    0.00)),  # air temp below base temp
    tc(c(20,   20,  44,  32,    0.00)),  # air temp equal to base temp
    tc(c(20,   26,  44,  32,    0.25)),  # air temp above base temp
    tc(c(20,   32,  44,  32,    0.50)),  # air temp equal to optimum temp
    tc(c(20,   38,  44,  32,    0.25)),  # air temp above optimum temp
    tc(c(20,   50,  44,  32,    0.00))   # air temp above maximum temp
)
