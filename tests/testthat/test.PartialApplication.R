...
test_that("functions generated by partial_run_biocro produce error messages when expected", {
    ...
    expect_error(
        miscanthus_func(list(weather$temp + temp_offset)),
        "The .* argument .* does not have the correct number of elements"
    )

    expect_error(
        miscanthus_func(c(weather$temp + temp_offset)),
        "The .* argument .* does not have the correct number of elements"
    )
})
...
test_that("functions generated by partial_run_biocro produce useful error messages", {
    ...
    expect_error(
        miscanthus_func(list(Catm = new_catm,
    ...
    expect_error(
        ...
        "The names used in the list passed to miscanthus_func do not match the list of names the function requires."
        ...
        ## (miscanthus_func here) from within the function.  This pending test
    ...
    expect_error(
        ...
        ## somewhat unlikely that any actual user would call miscanthus_func
