...
parameter_lists = list(
    willow =     name_parameters(willow_initial_values,                 willow_parameters,                 weather05, willow_steady_state_modules,                 willow_derivative_modules,                 willow_solver),
    miscanthus = name_parameters(miscanthus_x_giganteus_initial_values, miscanthus_x_giganteus_parameters, weather05, miscanthus_x_giganteus_steady_state_modules, miscanthus_x_giganteus_derivative_modules, miscanthus_x_giganteus_solver),
