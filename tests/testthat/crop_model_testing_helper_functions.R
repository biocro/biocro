...
PLANT_TESTING_INFO <- list(
    specify_crop("glycine_max",            TRUE,  glycine_max_initial_values,            glycine_max_parameters,            WEATHER,             std_lib(glycine_max_direct_modules),            std_lib(glycine_max_differential_modules),            glycine_max_ode_solver,            GLYCINE_MAX_IGNORE),            # INDEX = 1
    specify_crop("manihot_esculenta",      FALSE, manihot_esculenta_initial_values,      manihot_esculenta_parameters,      WEATHER,             std_lib(manihot_esculenta_direct_modules),      std_lib(manihot_esculenta_differential_modules),      manihot_esculenta_ode_solver,      MANIHOT_ESCULENTA_IGNORE),      # INDEX = 2
    specify_crop("miscanthus_x_giganteus", TRUE,  miscanthus_x_giganteus_initial_values, miscanthus_x_giganteus_parameters, WEATHER,             std_lib(miscanthus_x_giganteus_direct_modules), std_lib(miscanthus_x_giganteus_differential_modules), miscanthus_x_giganteus_ode_solver, MISCANTHUS_X_GIGANTEUS_IGNORE), # INDEX = 3
    specify_crop("sorghum",                TRUE,  sorghum_initial_values,                sorghum_parameters,                WEATHER,             std_lib(sorghum_direct_modules),                std_lib(sorghum_differential_modules),                sorghum_ode_solver,                SORGHUM_IGNORE),                # INDEX = 4
    specify_crop("willow",                 TRUE,  willow_initial_values,                 willow_parameters,                 WEATHER,             std_lib(willow_direct_modules),                 std_lib(willow_differential_modules),                 willow_ode_solver,                 WILLOW_IGNORE),                 # INDEX = 5
    specify_crop("zea_mays",               FALSE, zea_mays_initial_values,               zea_mays_parameters,               WEATHER,             std_lib(zea_mays_direct_modules),               std_lib(zea_mays_differential_modules),               zea_mays_ode_solver,               ZEA_MAYS_IGNORE),               # INDEX = 6
    specify_crop("soybean",                TRUE,  soybean_initial_values,                soybean_parameters,                soybean_weather2002, std_lib(soybean_direct_modules),                std_lib(soybean_differential_modules),                soybean_ode_solver,                SOYBEAN_IGNORE)                 # INDEX = 7
)
