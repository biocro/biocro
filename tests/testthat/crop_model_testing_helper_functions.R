...
PLANT_TESTING_INFO <- list(
    specify_crop("glycine_max",            TRUE,  glycine_max_initial_values,            glycine_max_parameters,            WEATHER,             module_creators(glycine_max_direct_modules),            module_creators(glycine_max_differential_modules),            glycine_max_ode_solver,            GLYCINE_MAX_IGNORE),            # INDEX = 1
    specify_crop("manihot_esculenta",      FALSE, manihot_esculenta_initial_values,      manihot_esculenta_parameters,      WEATHER,             module_creators(manihot_esculenta_direct_modules),      module_creators(manihot_esculenta_differential_modules),      manihot_esculenta_ode_solver,      MANIHOT_ESCULENTA_IGNORE),      # INDEX = 2
    specify_crop("miscanthus_x_giganteus", TRUE,  miscanthus_x_giganteus_initial_values, miscanthus_x_giganteus_parameters, WEATHER,             module_creators(miscanthus_x_giganteus_direct_modules), module_creators(miscanthus_x_giganteus_differential_modules), miscanthus_x_giganteus_ode_solver, MISCANTHUS_X_GIGANTEUS_IGNORE), # INDEX = 3
    specify_crop("sorghum",                TRUE,  sorghum_initial_values,                sorghum_parameters,                WEATHER,             module_creators(sorghum_direct_modules),                module_creators(sorghum_differential_modules),                sorghum_ode_solver,                SORGHUM_IGNORE),                # INDEX = 4
    specify_crop("willow",                 TRUE,  willow_initial_values,                 willow_parameters,                 WEATHER,             module_creators(willow_direct_modules),                 module_creators(willow_differential_modules),                 willow_ode_solver,                 WILLOW_IGNORE),                 # INDEX = 5
    specify_crop("zea_mays",               FALSE, zea_mays_initial_values,               zea_mays_parameters,               WEATHER,             module_creators(zea_mays_direct_modules),               module_creators(zea_mays_differential_modules),               zea_mays_ode_solver,               ZEA_MAYS_IGNORE),               # INDEX = 6
    specify_crop("soybean",                TRUE,  soybean_initial_values,                soybean_parameters,                soybean_weather2002, module_creators(soybean_direct_modules),                module_creators(soybean_differential_modules),                soybean_ode_solver,                SOYBEAN_IGNORE)                 # INDEX = 7
)
