...
& V_{c\,\text{max}}  = V_{c\,\max\,o} \cdot Kt(E_{vc\,max}) \label{eqn:Vcmax} \\
& R_{d}  =  R_{o} \cdot Kt(E_{Rd}) \label{eqn:Rd} \\
& M = \min\frac{\scriptstyle(V_{c,\text{max}}+\alpha_{\text{slope}}  I_{\text{abs}}) \pm \sqrt{(V_{c,\text{max}}+\alpha_{\text{slope}} I_{\text{abs}})^{2} - 4  (V_{c,\text{max}} \alpha_{\text{slope}}  I_{\text{abs}}) \theta_{\text{curve}}}}{2  \theta_{\text{curve}}} \label{eqn:M} 
\end{flalign}
...
& A_{\text{stroot}} = abs(\omega_{\text{stroot}} \cdot k_{\text{stroot}}) \; ; \; k_{\text{stroot}}<0 \label{eqn:Astroot} \\
& A_{\text{total}} = A_c + A_{\text{seed}} + A_{\text{stroot}} \label{eqn:Atotal} \\
...
& \omega_{\text{sroot}} = \omega_{\text{sroot}} + (A_{\text{total}} \cdot k_{\text{sroot}}) \label{eqn:omegasroot} \\
& \omega_{\text{froot}} = \omega_{\text{froot}} + (A_{\text{total}} \cdot k_{\text{froot}}) \label{eqn:omegafroot} \\
...
& R_{\text{total}} = (a \cdot A_{\text{gross}}) + (b_{\text{leaf}} \cdot \omega_{\text{leaf}}) + (b_{\text{stem}} \cdot \omega_{\text{stem}}) + (b_{\text{root}} \cdot \omega_{\text{root}}) \label{eqn:Rtotal} \\
