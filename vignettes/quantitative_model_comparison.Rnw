...
)
{
    ...
    gross_assim_center <-
        evaluate_module('BioCro:c3_leaf_photosynthesis', base_module_inputs)[['GrossAssim']]
    ...
    gross_assim_neg <-
        evaluate_module('BioCro:c3_leaf_photosynthesis', neg_module_inputs)[['GrossAssim']]
    ...
    gross_assim_pos <-
        evaluate_module('BioCro:c3_leaf_photosynthesis', pos_module_inputs)[['GrossAssim']]
