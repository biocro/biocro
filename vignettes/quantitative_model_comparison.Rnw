...
value of \ar. Since we are using the squared value of a residual as an error
metric, we are performing a simple version of nonlinear least-squares fitting.
