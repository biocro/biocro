...
\begin{align}
\rm 3 \, CO_2 + 6 \, NADPH + 6 \, H^+ + &9 \, ATP + 5 \, H_2O \rightarrow \\
                                        &(G3P) + 6 \, NADP^+ + 9 \, ADP + 8 \, P_i, (\#eq:cbb)
\end{align}
...
$\phi / 2 = \Gamma^* / C$ to rewrite this equation as follows:
\begin{equation}
...
where $T_p$ is the rate of triose phosphate utilization. This equation can be
...
will intentionally fail to restrict $A_p$ to its proper $C$ domain, allowing it
