...
$C = 0$:
\begin{equation}
\left. A_j \right|_{C = 0} = - \frac{\Gamma^* \cdot J}{8 \cdot \Gamma^*} - R_d
\end{equation}
and
\begin{equation}
\left. A_c \right|_{C = 0} = - \frac{\Gamma^* \cdot V_{cmax}}{K_c \cdot \left( 1 + O / K_o\right)} - R_d.
\end{equation}
...
\begin{equation}
\left. A_n \right|_{C = 0} = \max \left\{ \left. A_c \right|_{C = 0}, \left. A_j \right|_{C = 0} \right\}.
\end{equation}
