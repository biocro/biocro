...
<<C3photo,include=FALSE,echo=FALSE>>=
Qps <- seq(0,2000,10)
Tls <- seq(0,50,5)
rhs <- c(0.7)
...
@ 
<<echo=FALSE>>=
pdf("./figure/c3Intro-op100resid.pdf")
plot(op100, resid="raw")
dev.off()
@
\begin{figure}[htbp!]
  \centering
  \includegraphics[scale=0.8]{./figure/c3Intro-op100resid}
...
@
<<op100OvsF, echo=FALSE>>=
pdf("./figure/c3Intro-op100-OvsF.pdf")
plot(op100, plot.kind="OvsF")
dev.off()
pdf("./figure/c3Intro-op100-OandF.pdf")
plot(op100, plot.kind="OandF", type='o')
dev.off()
@
\begin{figure}[htbp!]
  \centering
  \includegraphics[scale=0.8]{./figure/c3Intro-op100-OvsF}  
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[scale=0.8]{./figure/c3Intro-op100-OandF}  
