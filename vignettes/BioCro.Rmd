...
[public BioCro Documentation web site](https://biocro.org), which includes
the following:

- Installation instructions

- A self-guided workshop ("Workshop I"), a "Practical Guide to BioCro," and
  other articles in the "Articles" dropdown menu
