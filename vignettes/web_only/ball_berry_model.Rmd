...
- The relative humidity at the leaf surface ($RH_s$) is mostly insensitive
  to the canopy depth (Figure \@ref(fig:hs-layer)).

- The stomatal conductance ($g_{sw}$) decreases with canopy depth
  (Figure \@ref(fig:gsw-layer)).

- The leaf temperature ($T_l$) increases with canopy depth
 (Figure \@ref(fig:tl-layer)).
