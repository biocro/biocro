...
\item \texttt{catm}: A list of the atmospheric [\cotwo] levels for 1980 - 2025.
...
years <- as.character(seq(1995, 2025))
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{
      ...
      expressed as percentages for each year from 1995 - 2025, plotted against
