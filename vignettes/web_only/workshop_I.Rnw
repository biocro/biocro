...
\newenvironment{boxEnv}[1]{
  ...
  \noindent
  {
    ...
    \ovalbox{\usebox{\mybox}}
  }
}

\newenvironment{boxCode}{\begin{boxEnv}{Code to run in R}}{\end{boxEnv}}
\newenvironment{boxCodeOptional}{\begin{boxEnv}{Code to (optionally) run in R}}{\end{boxEnv}}
\newenvironment{boxOutput}{\begin{boxEnv}{Expected output from R}}{\end{boxEnv}}
\newenvironment{boxExercise}{\begin{boxEnv}{Exercise}}{\end{boxEnv}}
...
\subsection{About this Workshop}
...
\noindent Look out for the following \textbf{bold} phrases inside boxes:
