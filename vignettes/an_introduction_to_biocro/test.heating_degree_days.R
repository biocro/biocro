...
test_that("If the ambient temperature is one degree below the threshold temperature, 1/24 of a heating degree day in each hour interval", {
...
test_that("When the ambient temperature is less than the threshold temperature, the heating degree day accumulation for the hour interval is 1/24 the difference", {
    number_of_samples <- 10
    temperature_deficits <- sample(1:200, number_of_samples)/10 # test deficits in the range of 0.1 to 20.0
