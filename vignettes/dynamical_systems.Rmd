...
generated by those inputs to module $\M_i$ that are not in $X$, $K$, or $D$.
(When constructing a dynamical system from BioCro modules, it is required that a
direct module's inputs and outputs are always disjoint. In this case,
