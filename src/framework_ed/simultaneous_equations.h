...
#include "../framework/module.h"     // For module_vector
...
void simultaneous_equations::run_modules(vector_type const& unknown_quantity_vector)
{
    ...
    // Clear all the outputs of direct modules in the main quantity map
 ...
 * simultaneous_equations object. This is required to use `calculate_jacobian()`
