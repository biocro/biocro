...
string_vector standardBML::c4_leaf_photosynthesis::get_inputs()
{
    return {
...
string_vector standardBML::c4_leaf_photosynthesis::get_outputs()
{
    return {
...
void standardBML::c4_leaf_photosynthesis::do_operation() const
{
