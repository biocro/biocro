...
int const standardBML::ten_layer_c3_canopy::nlayers = 10;  // Set the number of layers

string_vector standardBML::ten_layer_c3_canopy::get_inputs()
{
...
string_vector standardBML::ten_layer_c3_canopy::get_outputs()
{
...
void standardBML::ten_layer_c3_canopy::do_operation() const
{
