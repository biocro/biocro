   ...
   public:
    ed_c4_leaf_photosynthesis2(
        ...
        : se_module::base(ed_c4_leaf_photosynthesis2_stuff::module_name,
                          ed_c4_leaf_photosynthesis2_stuff::sub_mwps,
...
string_vector ed_c4_leaf_photosynthesis2::get_inputs()
{
    return se_module::get_se_inputs(ed_c4_leaf_photosynthesis2_stuff::sub_mwps);
}

string_vector ed_c4_leaf_photosynthesis2::get_outputs()
{
    string_vector outputs = se_module::get_se_outputs(ed_c4_leaf_photosynthesis2_stuff::sub_mwps);
