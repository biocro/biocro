...
const int ten_layer_rue_canopy::nlayers = 10;  // Set the number of layers

std::vector<std::string> ten_layer_rue_canopy::get_inputs()
{
...
std::vector<std::string> ten_layer_rue_canopy::get_outputs()
{
