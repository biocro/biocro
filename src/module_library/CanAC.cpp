...
)
{
    ...
    const double cf = 1;  // (Mg / ha / hr) / (micromol / m^2 / s)
    ...
    ans.Assim = CanopyA * cf;                      // micromol / m^2 / s
    ans.GrossAssim = GCanopyA * cf;                // micromol / m^2 / s
    ans.Rp = canopy_rp * cf;                       // micromol / m^2 / s
