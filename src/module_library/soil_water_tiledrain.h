...
string_vector soil_water_tiledrain::get_inputs()
{
    return {
        ...
        "deltaS_1",  // cm^3 [water] / cm^3 [soil]. Change in soil water content due to drainage in soil layer l
...
string_vector soil_water_tiledrain::get_outputs()
{
    return {
        ...
        "deltaT_1",           // cm^3 [water] / cm^3 [soil]. Change in soil water content due to tile drainage in layer 1 
        "deltaT_2",           // cm^3 [water] / cm^3 [soil]. Change in soil water content due to tile drainage in layer 2 
        "deltaT_3",           // cm^3 [water] / cm^3 [soil]. Change in soil water content due to tile drainage in layer 3 
        "deltaT_4",           // cm^3 [water] / cm^3 [soil]. Change in soil water content due to tile drainage in layer 4 
        "deltaT_5",           // cm^3 [water] / cm^3 [soil]. Change in soil water content due to tile drainage in layer 5 
        "deltaT_6"            // cm^3 [water] / cm^3 [soil]. Change in soil water content due to tile drainage in layer 6 
    };
}
