...
module_wrapper<ed_leaf_temperature> leaf_temperature;
   ...
   public:
    ed_c4_leaf_photosynthesis4(
        ...
        : se_module::base(ed_c4_leaf_photosynthesis4_stuff::module_name,
                          ed_c4_leaf_photosynthesis4_stuff::sub_mwps,
...
{
    return se_module::get_se_inputs(ed_c4_leaf_photosynthesis4_stuff::sub_mwps);
}

string_vector ed_c4_leaf_photosynthesis4::get_outputs()
{
    string_vector outputs = se_module::get_se_outputs(ed_c4_leaf_photosynthesis4_stuff::sub_mwps);
