 ...
 * calculations.
 */
struct CanopyPhotosynthesis {
    double assim;                           //!< Net CO2 assimilation rate (micromol / m^2 / s)
    double stomatal_vapor_conductance;      //!< Stomatal conductance to water vapor (mol / m^2 / s)
    double penman;            //!< P-M transpiration rate (mmol / m^2 / s)
    double priestly;          //!< Priestly transpiration rate (mmol / m^2 / s)
    double carboxylation;                   //!< Gross CO2 assimilation rate (micromol / m^2 / s)
    double leaf_respiration;                //!< Rate of non-photorespiratory CO2 release in the light (micromol / m^2 / s)
...
//CanopyPhotosynthesis canopy_photosynthesis(
...
//        
//        // leaf photosynthesis 
//        double direct_gsw_estimate = PhotoFunc(
...
//
//        photosynthesis_outputs direct_photo = PhotoFunc(
...
//
//        double diffuse_gsw_estimate = PhotoFunc(
...
//
//        photosynthesis_outputs diffuse_photo = PhotoFunc(
...
//
//template<typename PhotoFunc>
//struct CanopyPhotosynthesisModel
//{
//    CanopyPhotosynthesModel(
//      c3_temperature_response_parameters const tr_param,
//    double absorbed_longwave,            // J / m^2 / s
//    double ambient_temperature,          // degrees C
//    double atmospheric_pressure,         // Pa
...
//    double WindSpeed,            // m / s
//    double WindSpeedHeight      // m
//    ) : light_model{lightME(cosine_zenith_angle,
//                        atmospheric_pressure,
//                        atmospheric_transmittance,
//                        atmospheric_scattering)}, 
//        canopy_light_model{
//            light_model.direct_fraction * solarR,
//            light_model.diffuse_fraction * solarR,
//            chil,
//            cosine_zenith_angle,
//            heightf,
//            k_diffuse,
...
//        par_energy_fraction};
//
//    CanopyPhotosynthesis integrate(size_t nlayers){    
//        CanopyPhotosynthesis canopy(0);
//        
//        double gbw_guess{1.2};  // mol / m^2 / s
//        LightProfile light_profile;
