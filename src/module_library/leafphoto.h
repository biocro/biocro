...
{
    constexpr double divisor = 0.026934;
    constexpr double c0 = 0.047 / divisor;
    constexpr double c1 = -0.0013087 / divisor;
    constexpr double c2 = 2.5603e-05 / divisor;
    constexpr double c3 = -2.1441e-07 / divisor;
    return c0 + LeafT * (c1 + LeafT * (c2 + LeafT * c3));
}
