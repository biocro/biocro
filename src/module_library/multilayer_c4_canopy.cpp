...
using parent_class = multilayer_canopy_photosynthesis<ten_layer_canopy_properties, c4_leaf_photosynthesis>;
...
string_vector ten_layer_c4_canopy::get_inputs()
{
    ...
    // of layers
    return parent_class::generate_inputs(ten_layer_c4_canopy::nlayers);
}
...
string_vector ten_layer_c4_canopy::get_outputs()
{
    ...
    // of layers
    return parent_class::generate_outputs(ten_layer_c4_canopy::nlayers);
}
