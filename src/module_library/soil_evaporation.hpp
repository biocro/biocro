...
void soil_evaporation::do_operation() const
{
    ...
    double soilEvap = SoilEvapo(
        *lai_ip, 0.68, *temp_ip, *solar_ip, *soil_water_content_ip,
        *soil_field_capacity_ip, *soil_wilting_point_ip, *windspeed_ip, *rh_ip,
        *rsec_ip, *soil_clod_size_ip, *soil_reflectance_ip,
        *soil_transmission_ip, *specific_heat_of_air_ip, *stefan_boltzman_ip,
        *par_energy_content_ip);  // kg / m^2 / s
