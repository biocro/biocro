...
string_vector c3_leaf_photosynthesis_test::get_inputs()
{
    return {
...
string_vector c3_leaf_photosynthesis_test::get_outputs()
{
    return {
...
void c3_leaf_photosynthesis_test::do_operation() const
{
