 ...
 *
 * The result is expressed in two ways: as atmospheric transmittances (which
 * would be appropriate for calculating the intensity of direct and diffuse
 * light at the surface given a value for the solar constant) or as fractions
 * (which would be appropriate for calculating the intensity of direct and
 ...
 *
 * @param [in] atmospheric_transmittance
 *
 * @param [in] atmospheric_scattering
 *
