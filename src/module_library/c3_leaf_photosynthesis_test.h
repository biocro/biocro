#ifndef C3_LEAF_PHOTOSYNTHESIS_TEST_H
#define C3_LEAF_PHOTOSYNTHESIS_TEST_H
 ...
 */
class c3_leaf_photosynthesis_test : public direct_module
{
   public:
    ...
    static std::string get_name() { return "c3_leaf_photosynthesis_test"; }
