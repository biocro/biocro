...
struct Can_Str CanAC(double LAI, int DOY, double hr, double solarR, double Temp,
		     ...
		     double lowerT, const struct nitroParms &nitroP, double leafwidth, int eteq, double StomataWS, int water_stress_approach, double absorptivity_par);
...
struct Can_Str c3CanAC(double LAI, int DOY, double hr, double solarR, double Temp,
                       ...
                       double StomataWS, double growth_respiration_fraction, int water_stress_approach, double electrons_per_carboxylation, double electrons_per_oxygenation, double absorptivity_par);
