...
guess_growing_season_start_and_end_doy = function(climate, threshold_temperature) {
    ...
    day1 = ifelse(isEmpty(early_season_freezing_days),182, max(c(early_season_freezing_days, 90)))  # The first day of the season is the last freezing day, or day 90 at the earliest.
    ...
    dayn = ifelse(isEmpty(late_season_freezing_days),184,min(c(late_season_freezing_days, 330)))  # The last day of the season is the first freezing day, or day 330 at the latest.
