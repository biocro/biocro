...
oldqair2rh <- function(weachhumidity, weachtemp){
    ...
    satwatervappress<-(8.07131-(1730.63/(244.485+weachtemp)))*133 ## in pascal
    relativehumidity<-(waterpartialpress)/(satwatervappress) ##RH fraction
