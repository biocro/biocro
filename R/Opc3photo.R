...
## http://www.r-project.org/Licenses/ This is the Opc4photo and all of its
## realted functions
...
## object$data obsvec <- as.vector(dat[,1]) fittd <-
## c4photo(dat[,2],dat[,3],dat[,4],object$bestVmax,object$bestAlpha) ## Warning
## here I'm not taking into account different values of Rd, kparm, theta and
## beta rsd <- obsvec - fittd$Assim rss <- object$ReSumS ## Some measures of
