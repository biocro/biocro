...
##' .. content for \details{} ..
##' @title Soil Type
##' @param soiltype integer between 0 and 10
##' @return list with soil name and physical properties
##' @export
...
SoilType <- function(soiltype) {
    ...
    soiltype <- list(type = nm, silt = silt, clay = clay, sand = sand, air.entry = air.entry, 
