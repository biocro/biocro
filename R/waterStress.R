...
##'
##'
wtrstr <- function(precipt, evapo, cws, soildepth, fieldc, wiltp, phi1 = 0.01, phi2 = 10, wsFun = c("linear", "logistic", 
    "exp", "none")) {
    wsFun <- match.arg(wsFun)
    ## precipitation data are entered in mm but need to convert to m
    precipM = precipt * 0.001
    ## precipitation in meters can now be added to avaliable water to indicate the new avaliable water
    aw = precipM + cws
