Gro <- function(initial_values, parameters, drivers, modules, solver=list(type='Gro', output_step_size=1.0, adaptive_rel_error_tol=1e-4, adaptive_abs_error_tole=1e-4, adaptive_max_steps=200), verbose = FALSE)
{
    ...
    #
    #  result = Gro(sorghum_initial_values, sorghum_parameters, get_growing_season_climate(weather05), sorghum_modules, TRUE)
    ...
    #
    #  result = Gro(glycine_max_initial_values, glycine_max_parameters, get_growing_season_climate(weather05), glycine_max_modules, TRUE)
...
partial_gro <- function(initial_values, parameters, drivers, modules, arg_names, verbose = FALSE)
{
    ...
    #  sorghum_ss_modules <- c("soil_type_selector", "stomata_water_stress_linear", "leaf_water_stress_exponential", "parameter_calculator", "partitioning_coefficient_selector", "soil_evaporation", "c4_canopy", "partitioning_growth_calculator")
    #  sorghum_deriv_modules <- c("thermal_time_senescence", "partitioning_growth", "thermal_time_linear", "one_layer_soil_profile")
    #  senescence_gro <- partial_gro(sorghum_initial_values, sorghum_parameters, get_growing_season_climate(weather05), sorghum_ss_modules, sorghum_deriv_modules, c('seneLeaf', 'seneStem', 'seneRoot', 'seneRhizome'), TRUE)
    ...
    #
    #  senescence_gro <- partial_gro(sorghum_initial_values, sorghum_parameters, get_growing_season_climate(weather05), sorghum_ss_modules, sorghum_deriv_modules, c('seneLeaf', 'seneStem', 'seneRoot', 'seneRhizome'), FALSE)
    #  OR
    #  senescence_gro <- partial_gro(sorghum_initial_values, sorghum_parameters, get_growing_season_climate(weather05), sorghum_ss_modules, sorghum_deriv_modules, c('seneLeaf', 'seneStem', 'seneRoot', 'seneRhizome'))
