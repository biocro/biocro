...
phenoParms <- function(tp1=562, tp2=1312, tp3=2063, tp4=2676, tp5=3211, tp6=7000,
                       ...
                       kLeaf3=0.01, kStem3=0.63, kRoot3=0.01, kRhizome3=0.35, 
  ...
  list(tp1=tp1, tp2=tp2, tp3=tp3, tp4=tp4, tp5=tp5, tp6=tp6,
       ...
       kLeaf3=kLeaf3, kStem3=kStem3, kRoot3=kRoot3, kRhizome3=kRhizome3, 
       kLeaf4=kLeaf4, kStem4=kStem4, kRoot4=kRoot4, kRhizome4=kRhizome4, 
                      ...
                      panel = function(x, y, ...) {
                        ...
                        panel.xyplot(obs[, 1], obs[, 7], col = cols[6], 
                                     pch=pchs[6],...)
                                      ...
                                      "Seedcane", "Grain", "LAI")), col = cols, lines = TRUE, points=TRUE,
