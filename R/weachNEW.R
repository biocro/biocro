...
weachNEW <- function(X, lati, ts=1, temp.units = c("Farenheit", "Celsius"),
...
output<-cbind(year=numeric(0), doy=numeric(0),hour=numeric(0),SolarR=numeric(0),Temp=numeric(0),RH=numeric(0),WS=numeric(0),precip=numeric(0))
