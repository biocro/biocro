...
#' an integration of the photosynthesis function \code{\link{c3photo}}, canopy
#' evapo/transpiration \code{\link{CanA}}, the multilayer canopy model
#' \code{\link{sunML}} and a dry biomass partitioning calendar and senescence.
#' It also considers, carbon and nitrogen cycles and water and nitrogen
#' limitations.
#' 
#' 
#' @aliases SoilType canopyParms centuryParms nitroParms phenoParms photoParms
#' print.willowGro seneParms showSoilType soilParms willowCent willowGro
...
#' It should be supplied through the \code{photoParms} function.
#' 
...
#' phenological stages 1 through 6.
#' 
#' \code{kRhizome1-6} proportion of the carbon that is allocated to rhizome for
#' phenological stages 1 through 6.
#' 
...
#' layers specified.
#' 
#' \code{soilType} Soil type, default is 6 (a more typical soil would be 3). To
#' see details use the function \code{\link{showSoilType}}.
#' 
...
#' the distribution of roots in the soil profile and this parameter can be used
#' to change the lambda parameter of the Poisson.
#' 
...
#' 
#' \code{SC1-9} Soil carbon pools in the soil.  SC1: Structural surface litter.
#' SC2: Metabolic surface litter.  SC3: Structural root litter.  SC4: Metabolic
#' root litter.  SC5: Surface microbe.  SC6: Soil microbe.  SC7: Slow carbon.
#' SC8: Passive carbon.  SC9: Leached carbon.
#' 
...
#' 
#' @aliases SoilType canopyParms centuryParms nitroParms phenoParms photoParms
#' print.willowGro seneParms showSoilType soilParms willowGro
#' @param WetDat weather data as produced by the \code{\link{weach}} function.
#' @param day1 first day of the growing season, (1--365).
#' @param dayn last day of the growing season, (1--365, but larger than
#' \code{day1}). See details.
